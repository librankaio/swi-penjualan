                            ...
                            <table class="table table-bordered" id="datatable">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="border border-5" style="text-align: center;">No Bon</th>
                                        <th scope="col" class="border border-5" style="text-align: center;">Tanggal</th>
                                        <th scope="col" class="border border-5" style="text-align: center;">Pemesan</th>
                                        ...
                                        <th scope="col" class="border border-5" style="text-align: center;">hp</th>
                                        <th scope="col" class="border border-5" style="text-align: center;">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @php $counter = 0 @endphp
                                    @foreach($penjualans as $data => $item)
                                    @php $counter++ @endphp
                                    <tr>
                                        ...
                                        <td style="text-align: center;" class="d-flex justify-content-center">                                         
                                                ...
                                                Edit</i></a>
                                                <form action="/penjualan/delete/{{ $item->id }}" id="del-{{ $item->id }}"
