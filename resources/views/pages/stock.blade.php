    ...
    var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
        $(document).ready(function() {  
            ...
            $(document).on("click", "#addItem", function(e) {
                ...
                rowCount++;
                tablerow = "<tr row_id="+ rowCount +" id='row_"+rowCount+"'><th style='readonly:true;' class='border border-5'>" + rowCount + "</th><td class='border border-5'><input style='width:100%;' readonly form='thisform' class='namabrgclass form-control' name='nama_brg_d[]' type='text' value='" + nama_brg + "'></td><td class='border border-5'><input style='width:100%;' form='thisform' class='row_qty qtyclass form-control' name='qty_d[]' id='qty_d_"+ rowCount +"' type='text' value='" + qty + "'></td><td class='border border-5'><input style='width:100%;' readonly form='thisform' class='satuanclass form-control' name='satuan_d[]' type='text' value='" + satuan + "'></td><td class='border border-5'><a title='Delete' class='delete'><i style='font-size:15pt;color:#6777ef;' class='fa fa-trash'></i></a></td></tr>";
